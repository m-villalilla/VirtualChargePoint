		...
		Platform.runLater( () -> {
				...
				if(arg1 instanceof AuthorizeConfirmation) {
					if(((AuthorizeConfirmation) arg1).getIdTagInfo().getStatus().toString() == "Accepted") return;
						...
						fxmll.getNamespace().put("transImgUrl", "file:src/main/resources/TrafficlightRed.png");
					}
					...
					fxmll.getNamespace().put("transImgUrl", "file:src/main/resources/TrafficlightGreen.png");
				} else return;
